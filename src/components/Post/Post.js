        ...
        */}
        <div className="Post__content">

          {
            ...
            editing
              ?
              // Edit component captures a users new text to assign to a post
              // In order for the edit component to function, we will need to pass the updatePostFn prop
              // from Post.js as a prop into Edit.js
              //Also need to pass down the post's text and id so they can be used as arguments for the updatePostFn
              <Edit text={text}
                id={this.props.id}
                //hideEdit, method that hides the Edit component after updating a post's text.
